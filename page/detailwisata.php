...
<?php
    ...
    $wisata=mysql_query("SELECT *from wisata where id_wisata='$_GET[id_wisata]'");
    while ($r_wisata=mysql_fetch_assoc($wisata)):?>

    <div class=col-md-12>
        <div class=thumbnail>
         <a href= >
          <img src="<?php echo $r_wisata['foto_wisata'] ?>" width=576>
         </a> 
         <div class=caption>     
          <h3><?php echo $r_wisata['nama_wisata'] ?></h3>
          <h4><?php echo $r_wisata['kota'] ?></h4>
         <div class=paragraph> 
          <p align=justify><?php echo $r_wisata['deskripsi_wisata'] ?></p>
         </div>
         </div>
        </div>
        </div>
    ...
    <div class="row">
      <div class="col-md-6">
        <h3>Penilaian Wisata</h3>  
        <form method="post" action="">
        <input type="hidden" name="id_wisata" value="<?php echo $r_wisata['id_wisata'] ?>">  
        <h5>Beri Penilaian untuk Wisata ini! tinggal di geser saja!</h5>
    ...
    mysql_query("INSERT INTO k_wisata(rate,komentar,id_wisata) VALUES ('".$_POST['rate']."','".$_POST['komentar']."','".$_POST['id_wisata']."')"); 
    ?>
    <div class="col-md-6">
        <h3>Komentar Pengunjung</h3>            
        <?php
         $r=mysql_query("SELECT *from k_wisata where id_wisata = ".$r_wisata['id_wisata']." ");
