...
<html>
	...
	<div class="konten">
		<h4 align="center">Komentar User (Wisata)</h4>
		...
		<?php
		$sql=mysql_query("SELECT * from k_wisata");
		while($row=mysql_fetch_assoc($sql)){
		echo"
		<tr>
			<td>".$row['id_wisata']."</td>
			<td>".substr($row['komentar'],0,40)."....</td>
			<td>".$row['rate']."</td>
			<td><a href=h-komentarwisata.php?id=$row[id_kwisata]>Hapus</a>
		</tr>";	
		};
		echo "</table>";
	?>
